...
void loop() { if (millis() - timer > 30){ 
  ...
  value[0] = constrain(value[0], 0, 255);
  value[1] = constrain(value[1], 0, 255);
  value[2] = constrain(value[2], 0, 255);
  
  oldValue[0] = value[0];
  oldValue[1] = value[1];
  oldValue[2] = value[2];
  
  analogWrite(9, value[0]);
  analogWrite(11, value[1]);
